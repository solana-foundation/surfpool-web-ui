...
description: Complete public API for the surfpool-sdk crate — Surfnet, builder, cheatcodes, builders, errors, and re-exports.
---

The `surfpool-sdk` crate exposes a small surface centered on the `Surfnet` struct. This page lists every public item; for narrative usage, see the guides starting with [Overview](/sdk/overview).
