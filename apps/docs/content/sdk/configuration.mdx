---
title: Configuration
description: Configure a Surfnet at startup — remote RPC fallback, block production mode, slot timing, airdrops, feature gates, and custom payers.
---
...
```rust title="tests/configured.rs"
